    ...
    return (
        <div className="mainSecond">
            ...
            <div className="secondInner">
                <div>
                    <img loading="lazy" className="secondInnerImg" src={buy} alt="" />
                ...
                <div>
                    <img loading="lazy" className="secondInnerImg" src={sell} alt="" />
                ...
                <div>
                    <img loading="lazy" className="secondInnerImg" src={agent} alt="" />
